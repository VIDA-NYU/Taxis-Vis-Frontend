            ...
            <div className="query_description-stacked-list">
                ...
                {remainingCount > 0 && (
                    <Tooltip title={zones.slice(3).join(", ")}>
                        <div className="query_description-more-zones">+{remainingCount} More</div>
                    </Tooltip>
                )}
            </div>
        );
        ...
        >
            ...
            {isVisible && (
                <div className="query_description-container">
                    {formattedTimeRange && <div className="query_description-time-range">
                        ...
                        <div key={idx} className="query_description-item">
                            {desc.pickupZones && desc.pickupZones.length > 0 && (
                                <div className="query_description-stacked-section">
                                    ...
                                    <div className="query_description-inline-header">Pickup Zones</div>
                                </div>
                            )}
                            {desc.viaZone && (
                            ...
                            {desc.dropoffZones && desc.dropoffZones.length > 0 && (
                                <div className="query_description-stacked-section">
                                    <div className="query_description-inline-header">Dropoff Zones</div>
