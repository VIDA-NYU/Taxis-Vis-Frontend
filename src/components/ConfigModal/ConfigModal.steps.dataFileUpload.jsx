...
import {Box, Heading, Spinner, FormControl, FormLabel, Select, Input, Text} from "@chakra-ui/react";
...
export default function DataFileUpload({
    ...
    return (
        <Box textAlign="center" mt={6}>
            <Heading as="h3" size="md" mb={4}>Upload CSV</Heading>
            {isLoadingFile ? (
                ...
                <>
                    <FormControl mb={3}>
                        ...
                        <Select borderRadius="12px" value={delimiter} onChange={(e) => setDelimiter(e.target.value)}>
