...
import {
    ...
    removeLayerFromList,
    addKeyword,
    removeKeyword, handleSelectExisting, useConfigService, handleCreateNew,
...
export default function ConfigModal({isOpen = true, onClose, onConfigSelected}) {
    ...
    return (
        <ChakraProvider theme={THEME}>
            <Modal isOpen={isOpen} onClose={onClose} size="xl" className="config_modal_overlay">
                            ...
                            <TabPanels>
                                <TabPanel>
                                    <ConfigSelector
                                        ...
                                        onSelectConfig={() => handleSelectExisting(selectedConfig, onConfigSelected, onClose)}
                                    />
                                </TabPanel>
                                <TabPanel>
                                    <Box mt={4}>
                                        ...
                                        {activeStep === 4 && (
                                            <GeoJsonLayers
                                                ...
                                                handleAddKeyword={() => {
                                                    const updated = addKeyword(newKeyword, neighborhoodKeys);
                                                    setNeighborhoodKeys(updated);
                                                    setNewKeyword("");
                                                }}
                                                handleRemoveKeyword={(keywordToRemove) => {
                                                    setNeighborhoodKeys(removeKeyword(keywordToRemove, neighborhoodKeys));
                                                }}
                                                layers={layers}
                                                ...
                                                addLayer={() => {
                                                    setLayers((prev) => addLayerToList(prev, getRandomColor));
                                                }}
                                            />
                                        )}
                                    </Box>
